...
emulator-folder-missing = Esta pasta nao existe.
emulator-folder-wrong = Isto nao parece a pasta de dados do { $name }. Falta: { $missing }
emulator-folder-without-saves = Pasta certa, mas nao ha save nenhum nela. Procurei em: { $areas }. Se os seus jogos estao em outro disco, aponte aquela instalacao.
emulator-folder-ready = Pasta reconhecida: { $saves } arquivo(s) de save encontrados.
emulator-using-folder-without-saves = Usando { $path }, mas nao ha save nenhum nela. Se os seus jogos estao em outro disco, acrescente aquela instalacao como pasta abaixo.
